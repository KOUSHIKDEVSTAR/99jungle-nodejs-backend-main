...
const QUERY = require('../config/db-query/product-type');
...
//-------------------------------------------------------------
//  Product Type create API
//-------------------------------------------------------------
router.post('/create', checkToken, async function(req, res, next) {
    try {
    
        const {name, lavel, description} = req.body;
...
//-------------------------------------------------------------
//  get Product Type by filter data API
//-------------------------------------------------------------
