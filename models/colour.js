...
const colourSchema = new Schema({
  ...
  hexValue: { type: String, required: true, unique: false, trim: true, minLength: 1, maxLength: 10 },
  product_type_id: { type: ObjectId,  ref: 'ProductType', required: false, default: null }, 
...
module.exports = MONGOOSE.model('Color', colourSchema);